...
{
		$reviews_id = $_GET['id'];
		$sql1 = "SELECT * FROM reviews WHERE id = $reviews_id;";
                 ...
                 <li class="no-padding">
                    <ul class="collapsible collapsible-accordion">
                        <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-question-answer"></i> reviews</a>
                            <div class="collapsible-body">
                                <ul>
								<li><a href="all-reviews.php">All reviews</a>
                                </li>
								<?php
									$sql = mysqli_query($con, "SELECT DISTINCT status FROM reviews");
									while($row = mysqli_fetch_array($sql)){
                                    echo '<li><a href="all-reviews.php?status='.$row['status'].'">'.$row['status'].'</a>
                                    </li>';
									}
									?>
                                </ul>
